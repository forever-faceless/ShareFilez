...
export default function Page() {
  ...
  return (
    <div
      className="relative mx-auto flex h-screen w-screen bg-slate-100 bg-cover bg-center"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="flex w-full flex-col items-start justify-center gap-10 px-10 md:w-1/2 md:px-10">
        {/* Connection Status */}
        <h2 className="text-2xl font-extrabold text-black md:hidden">
          Receive Files Seamlessly
        </h2>
        <p className="text-base leading-relaxed text-black md:hidden lg:text-lg">
        ...
        <div className="text-center text-lg font-semibold text-black sm:text-xl">
          {isConnected ? (
        ...
        {/* File Details */}
        <div className="h-24 w-full overflow-auto rounded-md bg-slate-300 p-4 text-black md:w-3/4">
        ...
        <button
          ...
          className="h-10 w-32 rounded-md bg-slate-300 font-bold text-black shadow-lg transition hover:bg-slate-400"
        >
          Download
        </button>

        {/* Percentage Progress */}
        <div className="flex w-full flex-col items-center justify-center gap-4 text-lg font-semibold text-black sm:text-2xl md:w-3/4">
        ...
        {!isConnected && (
          <div className="mt-4 rounded-lg bg-slate-600 px-4 py-3 text-black shadow-md">
            <p className="font-semibold">⚠ Connection Lost</p>
            <p className="text-sm">
              Your connection was interrupted. Please{" "}
              <button
                onClick={() => window.location.reload()}
                className="text-black underline hover:text-slate-700"
              >
                refresh
              </button>{" "}
              to try again.
      ...
      <div className="hidden w-1/2 flex-col items-start justify-center gap-8 px-10 md:flex">
        {/* Title */}
        <h2 className="text-3xl font-extrabold text-black lg:text-4xl">
          Receive Files Seamlessly
        </h2>
        {/* Description */}
