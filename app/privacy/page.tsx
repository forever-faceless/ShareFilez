...
const Privacy = () => {
  return (
    <div
      className="relative mx-auto flex min-h-screen w-screen flex-col items-center justify-center bg-slate-100 bg-cover bg-center p-4 pt-14 text-black sm:p-6 md:p-8 lg:p-10"
    >
