...
export const Midground = () => {
  return (
    <div className="flex h-auto w-screen flex-col items-center justify-center gap-1 px-4 md:px-10">
      <h1 className="mb-8 text-3xl font-black text-black underline underline-offset-8 md:mb-16 md:text-5xl">
        How it Works?
      </h1>
      ...
      <div className="mt-8 flex flex-col flex-wrap justify-center gap-8 md:mt-12 md:flex-row md:gap-12">
        ...
        <div className="flex max-w-xs items-start gap-4 md:gap-6">
          ...
          />
          <div>
            <div className="text-lg font-bold text-black md:text-2xl">
              Direct Connection
            </div>
            <p className="text-xs leading-relaxed tracking-tight text-black md:text-sm">
