...
const FileShare: React.FC<FileShareProps> = ({ files }) => {
  ...
  return (
    <div className="flex h-auto w-full flex-col-reverse items-center justify-end gap-8 px-4 pt-8 text-black md:flex-row-reverse md:items-start md:justify-center md:px-8 md:pt-16">
      {/* Text Container */}
      <div className="flex w-full flex-col gap-6 md:w-2/5">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-center gap-3">
                <Input
                  ...
                  value={`https://share-filez.vercel.app/receiver?code=${shareCode}`}
                  readOnly
                />
                <button
                  className="rounded-md text-xl text-black md:text-3xl"
          ...
          <div className="flex flex-col gap-5">
            {!NearByShareCode ? (
              <Button
                ...
                className="md:text-md h-10 w-full bg-slate-400 text-sm font-bold text-black hover:bg-slate-500 md:h-11 md:w-60"
              ...
              <Button
                  className="h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-slate-400 text-base font-semibold text-black hover:bg-slate-500 md:h-14 md:w-fit md:text-xl"
          ...
          <Progress value={progress} className="w-full text-slate-400" />
        </div>
      </div>
